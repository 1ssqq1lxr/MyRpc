    ...
    xsi:schemaLocation="  
    	...
    	<bean id="perservice" class="com.it.netty.rpc.service.PersonServiceImpl"></bean>
 		<rpc:server id="test" serverPort="8096" zkAddress="127.0.0.1:12181">
 				<rpc:serviceRegeist class="com.it.netty.rpc.service.PersonService" timeout="5000"></rpc:serviceRegeist>
 		</rpc:server>
	</beans>  
	serverPort:默认开启tcp端口;
	class:提供服务的接口类（可写接口或者实现类）并且在 com.it.netty.rpc.service.PersonServiceImpl类上加上注解@RpcService
		...
		<beans xmlns="http://www.springframework.org/schema/beans"  
		    ...
		    xsi:schemaLocation="  
		        ...
		        <rpc:serviceBind id="123"  zkAddress="127.0.0.1:12181" proxy="cglib" clientGroup-thread-nums="50" protocol="HESSIAN">
		        			<rpc:serviceConsume name="personService" interface="com.it.netty.rpc.service.PersonService" ></rpc:serviceConsume>
		        </rpc:serviceBind>
		</beans>  
		interface:代理接口全限定名;
		zkAddress: zookeeper地址;
